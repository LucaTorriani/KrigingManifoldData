...
private:
  ...
  MatrixXd _residuals;
public:
  Model(const std::shared_ptr<const MatrixXd> data_tspace, const std::shared_ptr<const MatrixXd> design_matrix, unsigned int n): _data_tspace(data_tspace), _design_matrix(design_matrix),
