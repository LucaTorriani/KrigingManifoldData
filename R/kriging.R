...
#'
#' @param GLS_model the object returned by \code{model_GLS}, or a \code{list} containing the fields:
...
#' \code{fitted_par_vario} (estimates of \code{nugget}, \code{sill-nugget} and \code{practical range})
...
#' @return A \code{list} with a single field:
...
#' @details The model provided is used to perform simple/ordinary kriging on the tangent space in correspondence of the new locations.
