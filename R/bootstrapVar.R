...
#' @param res.boot A list of length \code{B}. Each field contains a list with the M predictions generated by the corresponding iteration
#' @param res.aggr A list of lenght M. Each field a single prediction, computed aggregating the corresponding data in res.boot 
...
#' @return It returns a vector of length M (i.e. the number of locations where we predict), containing the the prediction variance in the corresponding location
